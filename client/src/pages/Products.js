...
function Toast({ msg, type }) {
  if (!msg) return null;
  return (
    <div className={`toast toast-${type}`} role="alert" aria-live="polite" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
  ...
  return (
    ...
    >
      <div className="modal">
        ...
        {!canAfford && (
          <div className="alert alert-danger" style={{ marginTop: 14, display: 'flex', alignItems: 'center', gap: '8px' }}>
            <span style={{ display: 'flex' }}><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg></span> Insufficient balance.{' '}
  ...
  return (
    ...
    >
      <div className="modal success-modal">
        <div className="success-checkmark" aria-hidden="true" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    ...
    >
      ...
      <div className="product-card-body">
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 10, flexWrap: 'wrap', gap: 6 }}>
          <span className="badge badge-muted" style={{ fontSize: 11, display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
            {product.key_type === 'license_only' ? (
              <><span style={{ width: 14, height: 14, display: 'flex' }}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5m0 0l3 3L22 7l-3-3m-3.5 3.5L19 4"/></svg></span> License</>
            ) : (
              <><span style={{ width: 14, height: 14, display: 'flex' }}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></span> User/Pass</>
            )}
          </span>
          {minPrice !== null && (
    ...
    <div>
      ...
      {selected && (
        <div style={{ maxWidth: 660, margin: '0 auto' }}>
          <button className="btn btn-ghost btn-sm" onClick={goBack} style={{ marginBottom: 20, display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
            <span style={{ display: 'flex' }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg></span> Back
          </button>
          ...
          <div className="card">
            ...
            <p style={{ fontSize: 13, color: 'var(--text-muted)', marginTop: 6, marginBottom: 24, display: 'flex', alignItems: 'center', gap: '6px' }}>
              <span style={{ display: 'flex' }}>
                {selected.key_type === 'license_only' 
            ...
            {selectedDay && (user?.credits ?? 0) < selectedDay.price && (
              <div className="alert alert-warning" style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span style={{ display: 'flex' }}><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg></span> Not enough balance.{' '}
